      ...
      "Orders": [
        {
          ...
          "__v": 0,
          "orderDate": "2020-04-18T10:36:52.760Z",
          "orderID": "1001"
        },
      ]
    },
...
exports.setupDb = () => {
    return collection.getProductsCollection().then( ( product ) => {
        return product.deleteMany().then( () => {
            return product.insertMany( productsCol ).then( () => {
                return collection.getCustomersCollection().then( ( customer ) => {
                    return customer.deleteMany().then( () => {
                        return customer.insertMany( customersCol ).then( ( data ) => {
